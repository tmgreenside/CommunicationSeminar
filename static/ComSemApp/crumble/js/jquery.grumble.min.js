(function(a, k) {
    ...
    k.GrumbleBubble = function(j) {
        ...
        this.context = a(this.options.context);
        this.css = {};
        this.create()
    };
    k.GrumbleBubble.prototype = {
        create: function() {
            ...
            this.text = a(j(this.options.textTemplate, {
        ...
        setPosition: function() {
            var j = this.options.angle / -360,
                a = this.options.size / 2,
                f = this.options.size * this.options.size,
                f = Math.sqrt(f + f) / 2,
                d = this.options.left - a - Math.sin(j * 2 * Math.PI) * (this.options.distance + f);
        ...
        ieRotate: function() {
            var a = this.rotateDeg * (Math.PI * 2 / 360),
                h = Math.cos(a),
                a = Math.sin(a),
                f = this.bubble.get(0);
        ...
        tmpl: function(a, h, f) {
            for (var d in h) h[d] === null && (h[d] = ""), typeof h[d] === "object" && h[d].length && (h[d] = h[d].join(", ")), a = a.replace(RegExp("{" + d + "}", "g"), f ? escape(h[d]) : h[d]);
            return a
        }
    }
})($, window);
(function(a, k) {
    ...
    function j(f, d, e) {
        var c = a('<div style="position:absolute;visibility:hidden;width:' + f + 'px;">' + e + "</div>").appendTo(a(document.body)),
            h = c.outerHeight() * 2 + f * 0.2,
            b = a.inArray(f, d);
        c.remove();
    ...
    a.fn.grumble = function(f, d) {
        return typeof f === "string" ? (this.trigger({
            ...
            var e = a(this),
                c = a.extend({}, a.fn.grumble.defaults, f, e.data("grumble") || {}),
                d = j(c.size, c.sizeRange, c.text),
                b, g, i, n, m;
            ...
            i = {
                ...
                showBubble: function() {
                    i.isVisible != !0 && (c.showAfter && i.createFxQueue(), micro === !0 ? (b.bubble.queue("fx", function(a) {
                        b.bubble.show();
                        a()
                ...
                hideBubble: function() {
                    ...
                    micro === !0 ? (b.bubble.queue("fx", function(a) {
                        b.bubble.hide();
                        a()
                    }), b.bubble.queue("fx", function(a) {
                        b.text.hide();
